...
<body>
    ...
    <nav class="navbar">
        <div class="container">
            ...
            <ul class="nav-links">
                ...
                <li><a href="medical_form.php">prescription</a></li>
                <li><a href="contact">Answerposts</a></li>
            </ul>
            <div class="logo">
    ...
    <section class="about">
        <div class="container">
            ...
            <ul>
                <li>Access their medical records anytime, anywhere.</li>
                <li>Receive real-time updates on test results and treatment plans.</li>
