...
<!-- Payment Modal -->
<div id="paymentModal" class="modal modale">
    <div class="modal-content modale">
        ...
        <form id="paymentForm" action="process_payment.php" method="post">
            ...
            <input type="text" id="phoneNumber" name="phoneNumber" value="<?php echo htmlspecialchars($phone); ?>" readonly>
            <label for="amount">Amount:</label>
            <input type="text" id="amount" name="amount" value="<?php echo $totalCost; ?>" readonly>
...
<!-- a place where one can track amount paid and amount that is remaining  -->
