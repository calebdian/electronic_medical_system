...
<div class="sidebar" style="padding:0">
    ...
    <ul>
        ...
        <li><a href="medical_report.php" class="sidebar-link"><i class="fas fa-file-medical"></i> <span>Medical Records</span></a></li>
        <li><a href="medical_receipt.php" class="sidebar-link"><i class="fas fa-receipt"></i> <span>Medical Receipt</span></a></li>
        <li><a href="medical_form.php" class="sidebar-link"><i class="fas fa-file-alt"></i> <span>Medical Form</span></a></li>
        <li><a href="edit_profile.php" class="sidebar-link"><i class="fas fa-user"></i> <span>Profile</span></a></li>
